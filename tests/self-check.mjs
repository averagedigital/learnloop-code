...
assert.match(readmeSource, /установит Node\.js-зависимости, соберёт frontend, поднимет FalkorDB, Graph Memory и локальный Judge0/);
...
assert.match(envExampleSource, /^JUDGE0_BASE_URL=http:\/\/127\.0\.0\.1:2358$/m);
